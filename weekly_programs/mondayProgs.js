...
const monday = (time) => 
{
    ...
    {
        obj=  dataPrograms.find(x => x.progName == "الليتروجيه في حياتنا")
    }
    ...
    {
        obj=  dataPrograms.find(x => x.progName == "نداء الاحد")
    }
    ...
    {
        obj=  dataPrograms.find(x => x.progName == "التنشئة المسيحية")
    }
